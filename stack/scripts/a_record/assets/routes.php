routing::mount(function () {
  ...
  get('/:id', '<?php echo $model; ?>s#modify', array('path' => 'edit_<?php echo $model; ?>'));
  put('/:id', '<?php echo $model; ?>s#modify', array('path' => 'update_<?php echo $model; ?>'));
  delete('/:id', '<?php echo $model; ?>s#delete', array('path' => 'delete_<?php echo $model; ?>'));
