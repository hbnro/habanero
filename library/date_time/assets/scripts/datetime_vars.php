...
return array(
  'utc' => array(
    ...
    3 => '(UTC +3:30) Tehran',
    4 => '(UTC +4:30) Kabul',
    5 => '(UTC +5:45) Kathmandu',
    6 => '(UTC +6:00) Almaty, Dhaka, Colombo',
    7 => '(UTC +7:00) Bangkok, Hanoi, Jakarta',
    8 => '(UTC +8:00) Beijing, Perth, Singapore, HongKong',
    9 => '(UTC +9:30) Adelaide, Darwin',
...
/* EOF: ./library/date_time/assets/scripts/datetime_vars.php */
