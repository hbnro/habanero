...
class text
{
   ...
   * @return    string
   */
  final public static function urlify($text, $options = FALSE) {
    static $expr = NULL;
    ...
    $text = preg_replace_callback($expr, function ($matches)
      ...
      ! strpos($args['href'], '://') && $args['href'] = "http://$args[href]";
   ...
   * @return string
   */
  final public static function even($text, $repl = '%s', $ord = 124, $odd = FALSE) {
    $chr = char($ord);
   ...
   * @return string
   */
  final public static function alt(array $set = array()) {
    static $index = 0;
   ...
   * @return string
   */
  final public static function delim($text, $max = 3, $ord = 160) {
    $meta = str_repeat('.', $max);
    $expr = "/(.)(?=($meta)+(?!.))/";
   ...
   * @return string
   */
  final public static function left($text, $max = 0) {
   ...
   * @return string
   */
  final public static function right($text, $max = 0) {
   ...
   * @return string
   */
  final public static function words($text, $left = 100, $right = 0, $char = '&hellip;') {
    if ( ! empty($text)) {
   ...
   * @return    array
   */
  final public static function freq($text) {
    static $expr = NULL;
   ...
   * @return string
   */
  final public static function short($text, $left = 33, $right = 0, $glue = '&hellip;') {
    $prefix =
    $suffix = '';
   ...
   * @return    string
   */
  final public static function search($text, $find, $repl = '<strong>%s</strong>', $ord = 32) {
    static $latin = NULL;
   ...
   * @return array
   */
  final public static function find($text, $query = '', $chunk = '..', $length = 30) {
    $bad   =
    $good  = array();
